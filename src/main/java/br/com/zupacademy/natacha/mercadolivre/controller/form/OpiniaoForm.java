...
import br.com.zupacademy.natacha.mercadolivre.entity.Opiniao;
...
public class OpiniaoForm {
    ...
    public OpiniaoForm(@Min(1) @Max(5) Integer nota, @NotNull String titulo, @NotBlank @Length(max = 500) String descricao, @NotNull Long idProduto) {
        this.nota = nota;
        this.titulo = titulo;
